// Header search icon
export const SearchGlassIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LightModeIcon = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            className={className}
...
export const FollowingIcon = ({ width = '2.5rem', height = '2.5rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const FollowingActiveIcon = ({ width = '2.5rem', height = '2.5rem', className }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            className={className}
...
export const ProfileSidebarIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
    ...
    return (
        ...
        >
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M26 7a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v15H7a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h15v15a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V26h15a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1H26V7Z"
            ></path>
        </svg>
    );
};
